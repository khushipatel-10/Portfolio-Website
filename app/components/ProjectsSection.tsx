				...
				<div className="space-y-16">
					...
					>
						<div className="p-8">
							<h3 className="text-2xl font-bold text-purple-400 mb-2 flex items-center">
								<span>Figma to HTML Converter</span>
								<a
									href="https://github.com/khushipatel-10/Figma-to-HTML"
									target="_blank"
							...
							<p className="py-2 italic text-gray-400">Nov 2025</p>
							<p className="text-gray-200 mb-6">
								Developed a Python-based automation tool that converts Figma mockups into
								browser-ready HTML/CSS using the Figma REST API, automating design-to-code translation.
							</p>
							<ul className="space-y-2 text-m text-gray-400 mb-4">
								<li>• Engineered parsing logic to fetch and transform Figma design data into HTML/CSS elements</li>
								<li>• Validated element mapping accuracy with Pytest to ensure consistent fonts, colors, and layouts</li>
								<li>• Delivered an end-to-end converter within 14 hours, streamlining front-end development workflows</li>
							</ul>
						</div>
					</motion.div>
					...
					>
						<div className="p-8">
							...
							<p className="py-2 italic text-gray-400">Jun 2025 – Jul 2025</p>
							<p className="text-gray-200 mb-6">
